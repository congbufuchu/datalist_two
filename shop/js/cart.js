...
const box = document.querySelector('.list_width')
...
function bindHtml() {
  ...
  cartList.forEach(item => {
    str += `
      <li class="cart-item">
        <div class="left">
          <input ${item.is_select === 1 ? 'checked' : ''} id="select" data-id="${item.goodsid}" type="checkbox">
        </div>
        <div class="right">
          <div class="media">
            <div class="media-left">
              <a href="#">
                <img class="media-object" src="${item.goodsimage}" alt="...">
              </a>
            </div>
            <div class="media-body">
              ...
              <div class="btn-group pull-right" role="group" aria-label="...">
                <button data-id="${item.goodsid}" type="button" class="btn btn-default" id="sub" ${item.cart_number - 0 === 1 ? 'disabled' : ''}>-</button>
              ...
              <button id="del" data-id="${item.goodsid}" class="btn btn-danger">我不要了</button>
            </div>
          </div>
        </div>
      </li>
